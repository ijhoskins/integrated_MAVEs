...
base_file<- download.file("https://zenodo.org/records/10059317/files/integrative_MAVEs.tar.gz?download=1", destfile=data_dir, method="curl", mode="wb")
...
trp_trial4_ribofile<- Ribo(paste(comt_rp_dir, "20210607_COMT.ribo", sep="/"))
